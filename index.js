...
const swaggerOptions = {
    definition: {
      ...
      info: {
        title: 'My API',
        version: '1.0.0',
        description: 'API for my university project',
      },
      servers: [
        {
          url: 'http://localhost:4000', // or whatever your base URL is
        },
      ],
    },
    apis: ['./index.js'], // path to files with Swagger comments
};
 ...
 *     description: A simple endpoint that returns "Hello World!" text.
 *     responses:
 *       200:
 ...
 */
app.get('/', (req, res) => {
    res.status(200).json({ message: "Hola, mufas de mierda" });
}
);
